...
export function encodeMessages(message: Messages): Uint8Array {
  let bb = popByteBuffer();
  _encodeMessages(message, bb);
  return toUint8Array(bb);
}

function _encodeMessages(message: Messages, bb: ByteBuffer): void {
...
export function decodeMessages(binary: Uint8Array): Messages {
  return _decodeMessages(wrapByteBuffer(binary));
}

function _decodeMessages(bb: ByteBuffer): Messages {
  let message: Messages = {} as any;
